...
# NOTE: This function has been updated to use the new OpenAI v1.0.0+ syntax.
...
'''
    ...
    for round_num in range(rounds_max):
        ...
        # ==================== MODIFICATION START ====================
        # 教师回复（DMXAPI调用, using new openai library v1.0.0+）
        
        # 1. Create a client instance pointing to the custom endpoint
        client = OpenAI(
        ...
        try:
            ...
            # 3. Record usage field (convert Pydantic model to dict for JSON)
            if response.usage:
            ...
            teacher_response = f"[DSAPI请求异常: {e}]"
            logging.error(f"DSAPI请求异常: {e}")
            usage_list.append({})
        # ===================== MODIFICATION END =====================
...
'''
    ...
    output_data = {
        ...
        "referee_judgment": referee_judgment, 
...
if __name__ == "__main__":
    ...
    teacher_api_key = "sk-091f5bc59aa54b1bb9c1824efb1079db"  # 你的DMXAPI key
    ...
    all_model_stats = []
    result_root_dir = os.path.join(os.path.dirname(__file__), "result-v5")
